...
class Discover:
		...
		def _builder():
			for count, item in enumerate(data):
				try:
					...
					listitem.setProperty('fenda.context_main_menu_params', build_url({'mode': 'menu_editor.edit_menu_external', 'name': name, 'iconImage': default_icon}))
	...
	def help(self):
		text_file = translate_path('special://home/addons/plugin.video.fenda/resources/text/tips/135. Discover.txt')
