...
class source:
            ...
            def _process():
                for item in self.scrape_results:
                    try:
                        ...
                        if filter_title and not check_title(title, file_name, aliases, self.year, self.season, self.episode):
                            continue
    ...
    def _scrape_cloud(self):
        try:
            ...
            cloud_files = [
                i for i in cloud_files if i['path'].lower().endswith(tuple(extensions))]
