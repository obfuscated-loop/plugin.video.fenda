...
default_fanart_meta_movies = {'poster2': '', 'fanart2': '', 'clearlogo2': '', 'banner': '',
                              'clearart': '', 'landscape': '', 'discart': '', 'keyart': '', 'fanart_added': True}
default_fanart_meta_tv = {'poster2': '', 'fanart2': '', 'clearlogo2': '', 'banner': '', 'clearart': '', 'landscape': '', 'discart': '', 'keyart': '',
                          'season_art': {}, 'fanart_added': True}
default_fanart_nometa_movies = {'poster2': '', 'fanart2': '', 'clearlogo2': '', 'banner': '',
                                'clearart': '', 'landscape': '', 'discart': '', 'keyart': '', 'fanart_added': False}
...
default_all_fanart_images = {'poster': [], 'fanart': [], 'clearlogo': [
...
def get(media_type, language, media_id, client_key):
    ...
    if media_type == 'movies':
        ...
        fanart_data = {'poster2': parse_art(poster, language),
                       ...
                       'fanart_added': True}
        discart, keyart = [i['url']
                           for i in discart], [i['url'] for i in keyart]
    else:
...
def parse_season_art(art, language):
    ...
    for item in seasonart_keys:
        ...
        try:
            seasons = sorted(list(set([i['season'] for i in results if i['season'] != 'all' and (
